...
CREATE TABLE `repair_types` (
  ...
  `repair_period_txt` varchar(45) DEFAULT NULL,
  `repair_periods` varchar(100) DEFAULT NULL,
  `repair_type_txt` varchar(45) DEFAULT NULL,
  `repai_time_norms` varchar(100) DEFAULT NULL,
...
-- Dump completed on 2018-11-29 18:06:36
